...
child_links:
  ...
  - title: "Cuándo revisar tu menú — y por qué cambiar de app después de escalar sale caro"
    url: "/es/topic/when-to-review-your-menu/"
...
<div class="lf-key">
  ...
  <ul>
    <li>La navegación debe ajustarse a la etapa de la tienda, no al setup inicial.</li>
    <li>Catálogos pequeños necesitan simplicidad; los grandes estructura y velocidad.</li>
    <li>Revisa el menú cuando cambie el catálogo, el tema o el mercado.</li>
  </ul>
</div>
...
<p class="lf-note"><span class="lf-note-title">Revisa la etapa</span>Cuenta productos y categorías, luego prueba cuántos toques hacen falta para llegar a un producto.</p>
