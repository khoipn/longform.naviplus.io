...
child_links:
  - title: "指标 1——每个菜单项的点击率"
    url: "/zh-CN/topic/chi-so-ctr-menu/"
    desc: "哪些菜单项被点击，哪些被忽略。"
  - title: "指标 2——导航深度"
    url: "/zh-CN/topic/chi-so-navigation-depth/"
    desc: "顾客要走几步才能找到一件商品。"
  - title: "指标 3——分类页的退出率"
    url: "/zh-CN/topic/chi-so-exit-rate-danh-muc/"
    desc: "顾客进入了分类页，却没看任何商品就离开了。"
  - title: "指标 4——移动端与桌面端的导航行为"
    url: "/zh-CN/topic/chi-so-mobile-vs-desktop/"
    desc: "同一个菜单，两个完全不同的世界。"
  - title: "指标 5——站内搜索使用率"
    url: "/zh-CN/topic/chi-so-search-usage/"
...
<p class="lf-readmore"><span class="lf-readmore-kicker">深入了解</span><a href="/zh-CN/topic/chi-so-ctr-menu/">阅读完整指南 → 指标 1——每个菜单项的点击率</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">深入了解</span><a href="/zh-CN/topic/chi-so-navigation-depth/">阅读完整指南 → 指标 2——导航深度</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">深入了解</span><a href="/zh-CN/topic/chi-so-exit-rate-danh-muc/">阅读完整指南 → 指标 3——分类页的退出率</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">深入了解</span><a href="/zh-CN/topic/chi-so-mobile-vs-desktop/">阅读完整指南 → 指标 4——移动端与桌面端的导航行为</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">深入了解</span><a href="/zh-CN/topic/chi-so-search-usage/">阅读完整指南 → 指标 5——站内搜索使用率</a></p>
