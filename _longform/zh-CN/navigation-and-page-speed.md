...
child_links:
  - title: "Core Web Vitals 是什么，为什么和你有关"
    url: "/zh-CN/topic/core-web-vitals-explained/"
    desc: "LCP、INP、CLS——Google 关注的三个数字。"
  - title: "菜单应用如何影响速度，以及怎么发现它"
    url: "/zh-CN/topic/how-menu-apps-affect-page-speed/"
    desc: "沉重的 JavaScript、渲染阻塞、布局偏移。"
  - title: "一个好的菜单应用在速度上应该具备什么"
    url: "/zh-CN/topic/fast-menu-app-criteria/"
    desc: "信任一款应用之前要核对的五件事。"
  - title: "安装任何菜单应用之前的一份清单"
    url: "/zh-CN/topic/menu-app-installation-checklist/"
