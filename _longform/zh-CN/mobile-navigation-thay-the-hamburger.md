...
child_links:
  - title: "汉堡菜单在电商移动端真正的问题"
    url: "/zh-CN/topic/van-de-hamburger-menu/"
    desc: "藏得太多、多加了一步、放错了位置。"
  - title: "拇指可达区——理解人们是怎么握手机的"
    url: "/zh-CN/topic/thumb-zone-mobile/"
    desc: "最容易点到的位置是屏幕的中部和底部。"
  - title: "Tab Bar——最主要的替代方案"
    url: "/zh-CN/topic/tab-bar-giai-phap/"
    desc: "四到五个关键去处，始终可见。"
  - title: "组合使用 Tab Bar + Slide Menu（以及 FAB 的角色）"
    url: "/zh-CN/topic/ket-hop-tab-bar-slide-menu/"
    desc: "移动端店铺最常见的模式。"
---
...
<p class="lf-readmore"><span class="lf-readmore-kicker">深入了解</span><a href="/zh-CN/topic/van-de-hamburger-menu/">阅读完整指南 → 汉堡菜单在电商移动端真正的问题</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">深入了解</span><a href="/zh-CN/topic/thumb-zone-mobile/">阅读完整指南 → 拇指可达区——理解人们是怎么握手机的</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">深入了解</span><a href="/zh-CN/topic/tab-bar-giai-phap/">阅读完整指南 → Tab Bar——最主要的替代方案</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">深入了解</span><a href="/zh-CN/topic/ket-hop-tab-bar-slide-menu/">阅读完整指南 → 组合使用 Tab Bar + Slide Menu（以及 FAB 的角色）</a></p>
