...
date: 2026-06-02
child_links:
  - title: "The real problem with the hamburger menu on ecommerce mobile"
    url: "/topic/van-de-hamburger-menu/"
    desc: "Hides too much, adds a step, sits in the wrong place."
  - title: "Thumb zone — understanding how people hold their phones"
    url: "/topic/thumb-zone-mobile/"
    desc: "The easiest spots to tap are the middle and bottom of the screen."
  - title: "Tab Bar — the main alternative"
    url: "/topic/tab-bar-giai-phap/"
    desc: "Four or five key destinations, always visible."
  - title: "Combining Tab Bar + Slide Menu (and the role of the FAB)"
    url: "/topic/ket-hop-tab-bar-slide-menu/"
    desc: "The most common pattern for mobile stores."
---
...
<p class="lf-readmore"><span class="lf-readmore-kicker">Deep-dive</span><a href="/topic/van-de-hamburger-menu/">Read the full guide → The real problem with the hamburger menu on ecommerce mobile</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">Deep-dive</span><a href="/topic/thumb-zone-mobile/">Read the full guide → Thumb zone — understanding how people hold their phones</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">Deep-dive</span><a href="/topic/tab-bar-giai-phap/">Read the full guide → Tab Bar — the main alternative</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">Deep-dive</span><a href="/topic/ket-hop-tab-bar-slide-menu/">Read the full guide → Combining Tab Bar + Slide Menu (and the role of the FAB)</a></p>
