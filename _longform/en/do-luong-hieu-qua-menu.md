...
<p class="lf-readmore"><span class="lf-readmore-kicker">Deep-dive</span><a href="/topic/chi-so-ctr-menu/">Read the full guide → Metric 1 — Click-through rate of each menu item</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">Deep-dive</span><a href="/topic/chi-so-navigation-depth/">Read the full guide → Metric 2 — Navigation depth</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">Deep-dive</span><a href="/topic/chi-so-exit-rate-danh-muc/">Read the full guide → Metric 3 — Exit rate on category pages</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">Deep-dive</span><a href="/topic/chi-so-mobile-vs-desktop/">Read the full guide → Metric 4 — Mobile vs. desktop navigation behavior</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">Deep-dive</span><a href="/topic/chi-so-search-usage/">Read the full guide → Metric 5 — Internal search usage rate</a></p>
