...
child_links:
  - title: "Mega menu layout patterns: columns, grids, and tabs"
    url: "/topic/mega-menu-layout-patterns/"
    desc: "How to arrange subcategories, images, and links in a mega menu dropdown."
  - title: "Images in mega menus: when they help and when they clutter"
    url: "/topic/mega-menu-images/"
    desc: "Category images, featured products, and promotional banners in mega menu dropdowns."
  - title: "Category grouping in mega menus: logical structure"
    url: "/topic/mega-menu-category-grouping/"
    desc: "How to group subcategories so the mega menu makes sense at a glance."
  - title: "Mobile mega menu: translating wide dropdowns to small screens"
    url: "/topic/mobile-mega-menu/"
    desc: "How mega menus adapt on mobile — slide panels, progressive disclosure, and touch patterns."
---
...
<div class="lf-key">
  ...
  <ul>
    <li>Mega menus work best for stores with many categories — they show the full structure at a glance.</li>
    <li>Group subcategories logically (by type, by audience, by purpose) and limit each group to 5–8 items.</li>
    <li>Images in mega menus help when they add context — but too many images create visual clutter.</li>
  </ul>
</div>
...
<p class="lf-note"><span class="lf-note-title">Quick check</span>Open your mega menu and count the total items visible. If the number is over 40, check whether items can be grouped more tightly or whether some belong in a "View all" link instead.</p>
