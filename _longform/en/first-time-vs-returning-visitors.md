---
lang: en
ref: first-time-vs-returning-visitors
order: 14
...
seo_keywords:
  ...
  - returning customer navigation
  - ecommerce visitor types
  - personalized navigation
date: 2026-05-06
child_links:
  - title: "New visitor discovery: navigation that teaches your store"
    url: "/topic/new-visitor-discovery-navigation/"
    desc: "How first-time visitors learn a store's structure through the menu."
  - title: "Returning user shortcuts: navigation that remembers"
    url: "/topic/returning-user-shortcuts/"
    desc: "Recently viewed, quick reorder, and navigation that adapts to repeat visitors."
  - title: "Navigation personalization: what works and what doesn't"
    url: "/topic/navigation-personalization/"
    desc: "Dynamic menus, personalized categories, and the line between helpful and creepy."
  - title: "Adaptive navigation patterns for different visitor stages"
    url: "/topic/adaptive-navigation-patterns/"
    desc: "How the same menu can serve browsers, researchers, and ready-to-buy customers."
---
...
<div class="lf-key">
  ...
  <ul>
    <li>First-time visitors need navigation that explains the store. Returning customers need navigation that remembers them.</li>
    <li>Clear category labels and a logical hierarchy serve new visitors. Recently viewed items and shortcuts serve returning ones.</li>
    <li>A persistent tabbar gives both groups what they need — categories for discovery, cart for returning buyers.</li>
  </ul>
</div>
...
<p class="lf-note"><span class="lf-note-title">Quick check</span>Open your store in an incognito window (simulating a first-time visitor) and in your regular browser (where you're logged in). Does the experience feel different? It should.</p>
