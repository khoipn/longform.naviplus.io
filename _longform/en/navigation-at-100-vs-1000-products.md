---
lang: en
ref: navigation-at-100-vs-1000-products
order: 20
...
read_time: 6
seo_keywords:
  - navigation catalog growth
  - scaling ecommerce navigation
  - large catalog menu
  - small store navigation
date: 2026-04-20
child_links:
  - title: "Small catalog navigation: simplicity as a feature"
    url: "/topic/small-catalog-navigation/"
    desc: "Why stores with under 100 products need less menu, not more."
  - title: "Mid-size category strategy: organizing 100–500 products"
    url: "/topic/mid-size-category-strategy/"
    desc: "When to add subcategories, how to group, and avoiding premature complexity."
  - title: "Large catalog navigation: search, filters, and mega menus"
    url: "/topic/large-catalog-navigation/"
    desc: "At 500+ products, search and filtering become primary navigation — not the menu."
  - title: "Scaling patterns: how navigation evolves with the store"
    url: "/topic/navigation-scaling-patterns/"
    desc: "Common stages of navigation growth and when to restructure the menu."
---
...
<div class="lf-key">
  ...
  <ul>
    <li>Small catalogs (under 100 products) need simple navigation — a clean menu and good product pages.</li>
    <li>Mid-size catalogs (100–500) need subcategories and filters — the flat list stops working.</li>
    <li>Large catalogs (500+) need search, mega menus, and deep filtering — the menu becomes a gateway, not the primary tool.</li>
  </ul>
</div>
...
<p class="lf-note"><span class="lf-note-title">Quick check</span>Count your products, then check your largest collection page. If any collection shows more than 50 products without filters, your navigation hasn't kept pace with your catalog.</p>
