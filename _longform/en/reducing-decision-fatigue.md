...
child_links:
  - title: "The choice paradox: why more options reduce conversions"
    url: "/topic/choice-paradox-navigation/"
    desc: "Research on decision paralysis and how navigation overchoice hurts sales."
  - title: "Curated categories: navigation that guides decisions"
    url: "/topic/curated-categories-navigation/"
    desc: "How to organize menus around buyer intent instead of product attributes."
  - title: "Progressive disclosure: showing options gradually"
    url: "/topic/progressive-disclosure-navigation/"
    desc: "Menu depth, staged filtering, and revealing choices one level at a time."
  - title: "Smart defaults in navigation and filters"
    url: "/topic/navigation-smart-defaults/"
    desc: "Pre-selected filters, recommended categories, and nudging without forcing."
---
...
<div class="lf-key">
  ...
  <ul>
    <li>More menu options don't always help — beyond a threshold, they create decision paralysis instead of choice.</li>
    <li>Curated categories organized around shopper intent reduce the cognitive load of navigating.</li>
    <li>Progressive disclosure and smart defaults guide decisions without forcing them.</li>
  </ul>
</div>
...
<p class="lf-note"><span class="lf-note-title">Quick audit</span>Count the number of top-level items in your main menu. If it's more than 8–10, ask whether every item needs to be there, or whether some can be grouped under broader categories.</p>
