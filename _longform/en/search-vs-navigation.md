...
read_time: 7
seo_keywords:
  - search vs browse ecommerce
  - ecommerce search bar placement
  - search and navigation UX
  - mobile search ecommerce
date: 2026-04-29
child_links:
  - title: "Search bar patterns: placement, full-screen mobile, and instant results"
    url: "/topic/search-bar-patterns-ecommerce/"
    desc: "Where to put the search bar, what happens on tap, and why autocomplete changes everything."
  - title: "Category browse flow: how shoppers navigate without searching"
    url: "/topic/category-browse-flow/"
    desc: "Menu depth, progressive disclosure, and why some shoppers never use search."
  - title: "Mobile search UX: designing for thumbs and small screens"
    url: "/topic/mobile-search-ux-ecommerce/"
    desc: "Full-screen search, recent queries, and search in the tabbar."
  - title: "Search and navigation together: integrated discovery patterns"
    url: "/topic/search-navigation-integration/"
    desc: "Search within categories, mega menu search combos, and filters as navigation."
---
...
<div class="lf-key">
  ...
  <ul>
    <li>Searchers know what they want — they need speed and accuracy. Browsers are exploring — they need structure and discovery.</li>
    <li>On mobile, search should take over the full screen when tapped. The menu should be thumb-reachable.</li>
    <li>The two systems work best when they overlap: search within categories, search suggestions from the menu structure.</li>
  </ul>
</div>
...
<p class="lf-note"><span class="lf-note-title">Quick audit</span>Open your store on a phone. Without scrolling, can you see both the search bar and a way to access categories? If one is missing or hidden behind two taps, that's the group of shoppers you're underserving.</p>
