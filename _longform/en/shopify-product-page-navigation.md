---
lang: en
ref: shopify-product-page-navigation
order: 11
...
child_links:
  - title: "Breadcrumb patterns that actually help shoppers navigate"
    url: "/topic/breadcrumb-patterns-ecommerce/"
    desc: "Where to place them, how to handle mobile, and what Baymard's research says."
  - title: "Related products and cross-sell: navigating between products"
    url: "/topic/related-products-cross-sell-navigation/"
    desc: "Placement, relevance, and when cross-sell hurts more than it helps."
  - title: "Mobile product page navigation: back buttons, swipe, and sticky bars"
    url: "/topic/mobile-product-page-navigation/"
    desc: "Patterns for phones where breadcrumbs don't fit."
  - title: "Connecting product pages to your menu structure"
    url: "/topic/product-page-menu-integration/"
    desc: "How tabbar, mega menu, and quick-view tie into the product page."
---
...
<div class="lf-key">
  ...
  <ul>
    <li>Most shoppers leave product pages not because of the product — but because moving to the next one is too hard.</li>
    <li>Breadcrumbs, related products, and back-to-collection links each solve a different navigation gap.</li>
    <li>On mobile, where breadcrumbs barely fit, a persistent bottom bar changes everything.</li>
  </ul>
</div>
...
## Breadcrumbs: showing shoppers where they are
...
## Related products: moving sideways
...
<p class="lf-note"><span class="lf-note-title">Quick audit</span>Open a product page on your phone, then try to reach another product in the same collection using only what's on screen — no browser back button. Count the taps. If it takes more than two, there's room to improve.</p>
