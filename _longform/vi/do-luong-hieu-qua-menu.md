...
<p class="lf-readmore"><span class="lf-readmore-kicker">Đọc sâu</span><a href="/vi/topic/chi-so-ctr-menu/">Xem bài đầy đủ → Chỉ số 1 — Click-through rate của từng menu item</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">Đọc sâu</span><a href="/vi/topic/chi-so-navigation-depth/">Xem bài đầy đủ → Chỉ số 2 — Navigation depth (độ sâu điều hướng)</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">Đọc sâu</span><a href="/vi/topic/chi-so-exit-rate-danh-muc/">Xem bài đầy đủ → Chỉ số 3 — Exit rate tại trang danh mục</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">Đọc sâu</span><a href="/vi/topic/chi-so-mobile-vs-desktop/">Xem bài đầy đủ → Chỉ số 4 — Hành vi điều hướng mobile so với desktop</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">Đọc sâu</span><a href="/vi/topic/chi-so-search-usage/">Xem bài đầy đủ → Chỉ số 5 — Tỷ lệ dùng tìm kiếm nội bộ</a></p>
