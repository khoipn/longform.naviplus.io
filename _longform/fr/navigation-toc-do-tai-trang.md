...
child_links:
  - title: "Ce que sont les Core Web Vitals et pourquoi ils comptent pour vous"
    url: "/fr/topic/core-web-vitals-la-gi/"
  ...
  - title: "Comment une application de menu influe sur la vitesse — et comment le repérer"
    url: "/fr/topic/app-menu-anh-huong-toc-do/"
  ...
  - title: "Ce qui fait une bonne application de menu côté vitesse"
    url: "/fr/topic/tieu-chi-app-menu-nhanh/"
  ...
  - title: "Une liste de contrôle avant d'installer toute application de menu"
    url: "/fr/topic/checklist-cai-app-menu/"
...
<p class="lf-readmore"><span class="lf-readmore-kicker">Pour aller plus loin</span><a href="/fr/topic/core-web-vitals-la-gi/">Lire le guide complet → Ce que sont les Core Web Vitals et pourquoi ils comptent pour vous</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">Pour aller plus loin</span><a href="/fr/topic/app-menu-anh-huong-toc-do/">Lire le guide complet → Comment une application de menu influe sur la vitesse — et comment le repérer</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">Pour aller plus loin</span><a href="/fr/topic/tieu-chi-app-menu-nhanh/">Lire le guide complet → Ce qui fait une bonne application de menu côté vitesse</a></p>
...
<p class="lf-readmore"><span class="lf-readmore-kicker">Pour aller plus loin</span><a href="/fr/topic/checklist-cai-app-menu/">Lire le guide complet → Une liste de contrôle avant d'installer toute application de menu</a></p>
