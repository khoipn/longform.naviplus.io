...
<div class="lf-key">
  ...
  <ul>
    <li>La performance du menu se mesure sans analytics complexes.</li>
    <li>Les cinq métriques montrent où les clients cliquent, s’arrêtent ou cherchent.</li>
    <li>Corrigez un problème clair, puis attendez de nouvelles données.</li>
  </ul>
</div>
...
<p class="lf-note"><span class="lf-note-title">Commencez petit</span>Activez le suivi de recherche GA4, ajoutez des heatmaps, puis relisez les chiffres après deux semaines.</p>
