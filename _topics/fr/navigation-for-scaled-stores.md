...
seo_keywords:
  - navigation boutique à grande échelle
  - méga menu multicolonne
  - test A/B menu
  - multilingue
date: 2026-06-02
---
...
À ce stade, je sépare généralement le bureau et le mobile plutôt que d'utiliser une configuration commune. [Navi+](https://naviplus.io) permet de configurer les deux environnements de façon indépendante : c'est le moment d'en profiter.
...
Cet article fait partie du guide plus complet sur [La navigation à chaque étape de la croissance de votre boutique — de 10 à 10 000 produits](/fr/navigation-for-every-store-stage/).