...
parent_url: "/fr/navigation-toc-do-tai-trang/"
seo_keywords:
  - Core Web Vitals
  - LCP
  - INP
...
Cet article fait partie du guide plus complet sur [Navigation et vitesse de chargement — choisir une application de menu qui ne nuit pas aux Core Web Vitals](/fr/navigation-toc-do-tai-trang/).
