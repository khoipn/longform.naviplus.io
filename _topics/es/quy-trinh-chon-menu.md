...
parent_url: "/es/chon-loai-menu-shopify/"
seo_keywords:
  - proceso de selección de menú
  - Shopify Analytics
  - móvil vs escritorio
date: 2026-06-02
---
...
[Navi+](https://naviplus.io) te permite construir Tab Bars, Mega Menus, Slide Menus, FABs y Grid Menus sin código —solo arrastrar y soltar— y configurar móvil y escritorio por separado. Montas exactamente la configuración que elegiste en el Paso 4, un estilo por dispositivo, y luego activas el modo de vista previa. Como el menú se crea de forma independiente del tema, se mantiene intacto aunque cambies de tema más adelante.
...
Este artículo forma parte de la guía más amplia sobre [Cómo elegir el tipo de menú adecuado para tu tienda Shopify](/es/chon-loai-menu-shopify/).
