...
seo_keywords:
  - navegação de loja escalada
  - mega menu de múltiplas colunas
  - teste A/B de menu
  - multilíngue
date: 2026-06-02
---
...
Nesse estágio, eu costumo separar desktop e mobile em vez de usar uma única configuração compartilhada. O [Navi+](https://naviplus.io) permite configurar os dois ambientes de forma independente, então é a hora de aproveitar isso.
...
Este artigo faz parte do guia maior sobre [Navegação para Cada Estágio do Crescimento da Sua Loja — de 10 a 10.000 Produtos](/pt/navigation-for-every-store-stage/).
