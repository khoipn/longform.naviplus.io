...
image_alt: "Como um App de Menu Afeta a Velocidade da Página — e os Sinais de Alerta"
...
Este artigo faz parte do guia mais amplo sobre [Navegação e Velocidade de Carregamento — Como Escolher um App de Menu Que Não Prejudica os Core Web Vitals](/pt/navigation-and-page-speed/).
