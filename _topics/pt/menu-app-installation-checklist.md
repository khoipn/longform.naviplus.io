...
image_alt: "Um checklist para seguir antes de instalar qualquer app de menu"
...
Este artigo faz parte do guia maior sobre [Navegação e velocidade de página — escolhendo um app de menu que não prejudique os Core Web Vitals](/pt/navigation-and-page-speed/).
