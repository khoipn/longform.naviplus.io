...
Đây là chỗ một công cụ như [Navi+](https://naviplus.io) tiện việc: nó cho phép cấu hình menu desktop và mobile riêng biệt, kéo thả không cần code, và giữ nguyên menu khi bạn đổi theme. Bạn có thể đặt Mega Menu cho desktop, Tab Bar cộng Slide Menu cho mobile, mà không phải đụng tới file theme.
