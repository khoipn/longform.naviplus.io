...
## Breadcrumbs as passive teaching
...
This article is part of the larger guide on [Navigation for first-time vs returning visitors: what changes](/first-time-vs-returning-visitors/).
