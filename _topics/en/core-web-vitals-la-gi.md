...
parent_url: "/navigation-toc-do-tai-trang/"
seo_keywords:
  - Core Web Vitals
  - LCP
  - INP
...
This article is part of the larger guide on [Navigation and page speed — choosing a menu app that doesn't hurt Core Web Vitals](/navigation-toc-do-tai-trang/).
