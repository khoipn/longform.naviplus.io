...
## Navigation needs at this scale
...
At this stage, I usually separate desktop and mobile rather than using one shared configuration. [Navi+](https://naviplus.io) lets you configure the two environments independently, so this is the time to take advantage of that.
