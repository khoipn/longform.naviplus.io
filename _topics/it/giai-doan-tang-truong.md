...
seo_keywords:
  - navigazione negozio in crescita
  - mega menu
  - slide menu
  - analisi del menu
date: 2026-06-02
...
Vale la pena tenere a mente anche il contesto più ampio. Secondo il [Baymard Institute](https://baymard.com/lists/cart-abandonment-rate), il tasso medio di abbandono del carrello nell'ecommerce si aggira intorno al 70% e non è quasi cambiato in molti anni. Un menu non può risolvere tutto questo, ma un percorso ingarbugliato di certo non aiuta a trattenere i clienti.
...
Una cosa da tenere a mente quando aggiungi strumenti: la velocità della pagina. Secondo [Google](https://web.dev/articles/vitals), le soglie "buone" per i Core Web Vitals sono LCP sotto i 2,5 secondi, INP sotto i 200 millisecondi e CLS sotto 0,1. Un mega menu e uno slide menu, se costruiti in modo pesante, possono trascinare giù questi numeri. Più il negozio è grande, più tende a installare app, e ogni app può aggiungersi al tempo di caricamento — quindi il tuo menu dovrebbe essere snello e non rallentare la pagina.

## Configurazione consigliata con Navi+

Se non vuoi toccare alcun codice, ecco la configurazione che trovo adatta a un negozio in questa fase, realizzata con [Navi+](https://naviplus.io):
...
Questo articolo fa parte della guida più ampia su [La navigazione per ogni fase di crescita di un negozio — da 10 a 10.000 prodotti](/it/navigation-theo-giai-doan-store/).
